CREATE TABLE ENTRENADOR (
    ID_USER INT(30) UNSIGNED AUTO_INCREMENT PRIMARY KEY, 
...
CREATE TABLE MOVIMIENTOS (
    ID_MOVIMIENTO VARCHAR(20) NOT NULL PRIMARY KEY,
    POTENCIA INT,
...
CREATE TABLE POKEDEX(
    ...
    NUM_POKEMON VARCHAR(30) NOT NULL,
...
ALTER TABLE MOCHILA 
    ...
    ADD CONSTRAINT PK_MOCHILA_IDUSR PRIMARY KEY(ID_USER, ID_OBJETO),
